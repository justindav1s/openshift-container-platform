...
export SUDOUSER=justin
export PASSWORD=S@far123
export MASTER=ocpcluster-master
export MASTERPUBLICIPHOSTNAME=ocp.digitaldevops.net
export MASTERPUBLICIPADDRESS=51.145.13.213
export INFRA=ocpcluster-infra
export NODE=ocpcluster-node
export NODECOUNT=1
export INFRACOUNT=1
export MASTERCOUNT=1
export ROUTING=apps.digitaldevops.net
export METRICS=true
export LOGGING=true
export AZURE=yes
